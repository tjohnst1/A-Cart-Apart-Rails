...
describe 'authentication pages' do
  ...
  it 'allows a user to sign in with a e-mail address' do
    FactoryGirl.create(:user)
    visit food_carts_path
    click_on 'Sign In'
  ...
  it 'allows a user to sign in with a username', login: true do
    expect(page).to(have_content('Signed in successfully.'))
  end
  it 'allows a user to sign out', login: true do
    click_on 'Sign Out'
